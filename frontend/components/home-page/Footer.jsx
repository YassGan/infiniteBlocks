...
const footerLinks = [
  {
    ...
    links: [
      ...
      { label: "About us", href: "/pages-menu/about-us" },
      { label: "Careers", href: "/blog/blog-landing-page" },
      { label: "Features", href: "/pages-menu/service-v1" },
      { label: "Demo the product", href: "/blog/blog-landing-page" },
    ],
  },
  {
    title: "Legal",
  ...
  },
  {
    ...
    links: [
      ...
      { label: "infiniteblocks Reviews", href: "/pages-menu/faq" },
    ],
  },
];
